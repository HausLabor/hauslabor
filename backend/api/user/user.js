...
const userSchema = new mongoose.Schema({
    ...
    access: { type: Number, min: 1, max: 4, required: [false, 'Informe o nivel de acesso do Usuário!']}, //Type 1 - PACIENTE / 2 - ESPECIALISTA / 3 - HARDWARE / 4 - ADMINISTRADOR 
    lastacess: { type: Date, require: true},
    completeUser: { type: String, require: true},
